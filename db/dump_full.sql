...
INSERT INTO `directories_data` VALUES (1,1,'ODEON LIGHT',0),(2,2,'Китай',0),(3,3,'очень стильный',0),(4,4,'на потолке',0),(5,4,'на стене',0),(6,4,'на столе',0),(7,4,'под столом :)',0),(8,5,'стекло',0),(9,5,'металл',0),(24,1,'OSRAM',0),(11,5,'ткань',0),(12,6,'бежевый',0),(13,6,'голубой',0),(14,6,'светло-желтый',0),(15,7,'белый',0),(16,7,'прозрачный',0),(17,7,'прозрачный матовый',0),(18,8,'Потолочные люстры с вентилятором',0),(19,8,'Потолочные люстры хрустальные',0),(20,9,'ЛПодв-1',0),(21,9,'ЛПодв-2',0),(22,10,'Хрустальные бра',0),(23,10,'Бра в стиле флористика',0),(25,8,'Классические потолочные люстры',0),(26,8,'Современные потолочные люстры в стиле «модерн»',0);
...
INSERT INTO `menus_items` VALUES (1,'О КОМПАНИИ','',0,1,1,1,''),(2,'ВАКАНСИИ','',0,2,1,1,''),(3,'ВОПРОС-ОТВЕТ','/faq.html',0,3,1,1,''),(4,'СТАТЬ ДИЛЕРОМ','',0,4,1,1,''),(5,'КОНТАКТЫ','',0,5,1,1,''),(6,'ПОЧЕМУ МЫ','',1,1,1,1,''),(7,'НАША КОМАНДА','/staff.html',1,2,1,1,''),(8,'АКЦИИ, КУПОНЫ','/actions.html',1,3,1,1,''),(9,'ОТЗЫВЫ КЛИЕНТОВ','/feedback.html',1,4,1,1,''),(10,'ПАРТНЕРЫ','',1,5,1,1,''),(11,'Потолки','',0,1,2,1,''),(12,'Люстры','/lights',0,2,2,1,''),(13,'Жалюзи','',0,3,2,1,''),(14,'Окна','',0,4,2,1,''),(15,'О ПОТОЛКАХ','',11,1,2,1,''),(16,'КАК СДЕЛАТЬ ЗАКАЗ','',11,2,2,1,''),(17,'ГОТОВЫЕ РЕШЕНИЯ','/ceil_solutions/1',11,3,2,1,''),(18,'ФАКТУРЫ','',11,4,2,1,''),(19,'О ЖАЛЮЗИ','',13,1,2,1,''),(20,'ГОТОВЫЕ РЕШЕНИЯ','',13,2,2,1,''),(21,'СИСТЕМЫ','',13,3,2,1,''),(22,'ПРЕИМУЩЕСТВА НАТЯЖНЫХ ПОТОЛКОВ','',15,1,2,1,''),(24,'УСТАНОВКА ПОТОЛКОВ','',15,2,2,1,''),(25,'РЕМОНТ','',15,3,2,1,''),(26,'ЧТО ДЕЛАТЬ?','',16,1,2,1,''),(27,'ЗАЯВКА НА ЗАМЕР','',16,2,2,1,''),(28,'Люстры потолочные','',0,1,3,1,'1'),(29,'Люстры подвесные','',0,2,3,1,'2'),(30,'Бра','',0,3,3,1,'3'),(31,'Детские светильники','',0,4,3,1,'4'),(32,'Светильники для кухни','',0,5,3,1,'5'),(33,'Настенно-потолочные светильники','',0,6,3,1,'6'),(34,'Встраиваемый светильник','',0,7,3,1,'7'),(35,'Светильники для ванной','',0,8,3,1,'8'),(36,'Подсветка для картин и зеркал','',0,9,3,1,'9'),(37,'Подвесные светильники','',0,10,3,1,'10'),(38,'Торшеры','',0,11,3,1,'11'),(39,'Настольные лампы','',0,12,3,1,'12'),(40,'Хрустальные люстры','',0,13,3,1,'13'),(41,'Светильники уличные','',0,14,3,1,'14'),(42,'Споты и трек-системы','',0,15,3,1,'15');
...
) ENGINE=MyISAM AUTO_INCREMENT=272 DEFAULT CHARSET=cp1251;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shop_tree_node_details` VALUES (247,1,'lamps_exists','c','1'),(246,1,'color_glass','dm','16'),(245,1,'color_glass','dm','15'),(244,1,'color','dm','13'),(243,1,'color','dm','12'),(242,1,'material','dm','9'),(241,1,'material','dm','8'),(240,1,'placing','do','4'),(239,1,'style','do','3'),(238,1,'collection','s','винтаж'),(89,1,'image','i','f4f6675429ad86c90.jpg'),(237,1,'area','d','10'),(236,1,'lamp_count','d','5'),(235,1,'power','d','30'),(234,1,'lamp_type','e','E27'),(233,1,'length','d','2000'),(232,1,'width','d','1200'),(231,1,'height','d','500'),(230,1,'type','do','18'),(229,1,'country','do','2'),(228,1,'maker','do','1'),(130,3,'image','i','7ea389c95339e38c0.jpg'),(227,3,'lamps_exists','c','0'),(226,3,'price','d','2900'),(223,3,'color','dm','13'),(224,3,'color','dm','14'),(225,3,'color_glass','dm','17'),(222,3,'color','dm','12'),(221,3,'material','dm','9'),(220,3,'material','dm','8'),(219,3,'placing','do','7'),(218,3,'style','do','3'),(217,3,'collection','s','винтаж'),(216,3,'area','d','12'),(215,3,'lamp_count','d','5'),(214,3,'power','d','40'),(213,3,'lamp_type','e','E14'),(212,3,'diametr','d','300'),(211,3,'type','do','19'),(210,3,'country','do','2'),(209,3,'maker','do','24'),(202,2,'image','i','e8d27f9f88c23e9d0.jpg'),(254,2,'power','d','30'),(253,2,'lamp_type','e','G4'),(252,2,'diametr','d','500'),(251,2,'type','do','18'),(250,2,'country','do','2'),(249,2,'maker','do','1'),(248,1,'price','d','3500'),(255,2,'lamp_count','d','3'),(256,2,'collection','s','винтаж'),(257,2,'material','dm','8'),(258,2,'material','dm','11'),(259,2,'color','dm','12'),(260,2,'color','dm','13'),(261,2,'color_glass','dm','16'),(262,2,'price','d','2500'),(263,2,'lamps_exists','c','0'),(264,4,'maker','do','24'),(265,4,'type','do','22'),(266,4,'lamp_type','e','E27'),(267,4,'power','d','30'),(268,4,'lamp_count','d','1'),(269,4,'placing','do','5'),(270,4,'price','d','2800'),(271,4,'lamps_exists','c','0');
...
INSERT INTO `shop_tree_nodes` VALUES (1,3,1,28,'2006/4C','Люстра потолочная','',0,'2014-04-13',1,0,0),(2,3,1,28,'LYSTR2','Люстра потолочная 2','',0,'2014-04-13',1,0,0),(3,3,1,28,'2006/4E','Люстра потолочная 3','',0,'2014-04-19',0,0,0),(4,3,3,30,'CL511513','Бра CL511513','',0,'2014-04-28',0,0,0);
...
-- Dump completed on 2014-04-29 22:13:32
