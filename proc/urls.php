 ...
 *
 * Формат пути:
 * для текстовых разделов:  @pre{ /<menu_item_id>.html }
 * для заданных урлов: @pre{ /<menu_item_id>/menu_item_url }
 *
...
/**
 * Возвращает путь в меню от корня раздела до заданного пункта меню.
...
function get_menu_item_path($id, $parent = null)
{
	...
	// Получим данные текущего раздела для запуска цикла обхода дерева
