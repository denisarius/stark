 ...
 *
 * Формат пути:
 * 1. Для текстовых подразделов:  @pre{ /<menu_item_id>.html }.
 ...
 * 3. Для заданных динамических урлов: @pre{ /menu_item_url/<menu_item_id>/0.html },
 *   где menu_item_url может быть произвольным.
 *
 * Таким образом, имеется соглашение, что ид подраздела меню располагается либо в конце пути, (<id>.html),
 * если <id> - число, большее 0, либо на предпоследнем сегменте пути.
 *
